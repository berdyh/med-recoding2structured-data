...
class TestValidatorScalarFields:
    """Tests for simple scalar validation helpers."""
...
class TestValidatorIdentifiers:
    """Tests for identifiers and required field validations."""
    ...
    def test_validate_nhs_number_invalid_length(self, validator):
        ...
        assert validator.validate_nhs_number("12345") is False
        assert validator.validate_nhs_number("123456789012") is False

    def test_validate_nhs_number_invalid_characters(self, validator):
        """Test NHS number validation with invalid characters."""
        assert validator.validate_nhs_number("123456789a") is False
        assert validator.validate_nhs_number("123456789-") is False
    ...
    def test_validate_phone_invalid(self, validator):
        ...
        assert validator.validate_phone("abc") is False
    ...
    def test_validate_required_field_present(self, validator):
        ...
        assert validator.validate_required_field(0, "field_name") is True
...
class TestValidatorEntityValidation:
    """Tests for entity-level validation helpers."""
    ...
    def test_validate_symptom_valid(self, validator):
        ...
        symptom = {
            "class": "symptom_name",
            "text": "headache",
            "attributes": {"severity": "moderate", "duration": "3 days"},
        }
    ...
    def test_validate_medication_valid(self, validator):
        ...
        medication = {"class": "medication", "text": "Aspirin", "attributes": {"dosage": "100mg"}}
    ...
    def test_validate_vital_signs_valid(self, validator):
        ...
        vital_signs = {"class": "temperature", "text": "37.5", "attributes": {}}
...
class TestValidatorAggregation:
    """Tests covering validate_all aggregation and reporting."""
    ...
    def test_validate_all_with_valid_data(self, validator):
        ...
        data = {
            ...
            "medications": [{"class": "medication", "text": "Aspirin", "attributes": {}}],
            "diagnoses": [
                {"class": "diagnosis", "text": "Migraine", "attributes": {"certainty": "probable"}}
            ],
        }
    ...
    def test_validate_all_with_invalid_data(self, validator):
        ...
        data = {
            ...
            "medications": [
                {"class": "medication", "text": "Aspirin", "attributes": {"dosage": -10.0}}
            ],
            "diagnoses": [
                {
                    "class": "diagnosis",
    ...
    def test_validate_all_empty_data(self, validator):
        ...
        data = {"symptoms": [], "medications": [], "diagnoses": []}
        is_valid, errors = validator.validate_all(data)
        assert is_valid is True
        assert len(errors) == 0
    ...
    def test_validate_all_aggregation(self, validator):
        ...
        data = {
            "symptoms": [
                {"class": "symptom_name", "text": "headache", "attributes": {"severity": "invalid"}}
            ],
            "medications": [
                {"class": "medication", "text": "Aspirin", "attributes": {"dosage": -5.0}}
            ],
            "diagnoses": [
                {"class": "diagnosis", "text": "Migraine", "attributes": {"certainty": "invalid"}}
            ],
        }
        is_valid, errors = validator.validate_all(data)

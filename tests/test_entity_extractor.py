...
class TestClinicalEntityExtractor:
    ...
    def test_extract_symptoms(
        self, mock_lx, mock_llm_provider, few_shot_config_file, mock_langextract_result
    ):
    ...
    def test_retry_logic_on_failure(
        self, mock_sleep, mock_lx, mock_llm_provider, few_shot_config_file
    ):
        ...
        mock_lx.extract.side_effect = [Exception("API rate limit exceeded"), mock_result]
    ...
    @patch("entity_extractor.lx")
    def test_relationship_attribute_grouping(
        self, mock_lx, mock_llm_provider, few_shot_config_file
    ):
    ...
    @patch("entity_extractor.lx")
    def test_parse_extraction_result_with_attributes(
        self, mock_lx, mock_llm_provider, few_shot_config_file
    ):
    ...
    @patch("entity_extractor.lx")
    def test_parse_extraction_result_without_attributes(
        self, mock_lx, mock_llm_provider, few_shot_config_file
    ):

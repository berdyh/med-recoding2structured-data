...
class TestDataMapper:
    ...
    def test_group_entities_by_attribute(self, mapper):
        ...
        entities = [
            ...
            {'class': 'medication', 'text': 'Ibuprofen', 'attributes': {'medication_group': 'med_2'}},
        ]
    ...
    def test_map_diagnoses_with_data(self, mapper):
        ...
        diagnoses = [
            {'class': 'diagnosis', 'text': 'acute back strain', 'attributes': {'diagnosis_group': 'diag_1'}},
    ...
    def test_parse_temperature(self, mapper):
        ...
        assert abs(temp - 38.0) < 0.5  # Approximate conversion
    ...
    def test_foreign_key_consistency(self, mapper):
        ...
        assert medications_df.iloc[0]['consultation_session_id'] == str(mapper.consultation_session_id)

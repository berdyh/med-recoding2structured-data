...
class TestLLMProviderManager:
    ...
    def test_init_with_gemini_provider(self):
        ...
        config = {
            "provider": "gemini",
            "gemini": {"api_key": "test-api-key", "model": "gemini-2.5-pro"},
        }
    ...
    def test_get_gemini_credentials(self):
        ...
        config = {
            "provider": "gemini",
            "gemini": {"api_key": "test-api-key-12345", "model": "gemini-2.5-pro"},
        }
    ...
    def test_get_bedrock_credentials_with_defaults(self):
        ...
        config = {"provider": "bedrock", "bedrock": {}}
    ...
    def test_validate_gemini_credentials_success(self):
        ...
        config = {
            "provider": "gemini",
            "gemini": {"api_key": "valid-api-key-12345", "model": "gemini-2.5-pro"},
        }
    ...
    def test_validate_gemini_credentials_invalid_key(self):
        ...
        config = {"provider": "gemini", "gemini": {"api_key": "short"}}
    ...
    def test_validate_bedrock_credentials_no_credentials(self, mock_boto_client):
        ...
        config = {"provider": "bedrock", "bedrock": {"region": "us-east-1"}}
    ...
    def test_get_bedrock_client_wrong_provider(self):
        ...
        config = {"provider": "gemini", "gemini": {"api_key": "test-key-12345"}}

...
class TestCSVExporter:
    ...
    def test_export_table_with_data(self, exporter, temp_output_dir):
    ...
    def test_export_table_empty(self, exporter, temp_output_dir):
    ...
    def test_export_table_with_null_values(self, exporter, temp_output_dir):
        """Test exporting table with NULL values."""
        df = pd.DataFrame({
            'id': [1, 2, 3],
            'name': ['Alice', None, 'Charlie'],
            'value': [10.5, None, 30.1]
        })
    ...
    def test_export_table_with_special_characters(self, exporter, temp_output_dir):
    ...
    def test_export_all(self, exporter, temp_output_dir):
        """Test exporting multiple tables."""
        mapped_data = {
            'symptoms': pd.DataFrame({
                'symptom_id': ['uuid1', 'uuid2'],
                'symptom_name': ['headache', 'fever']
            }),
            'medications': pd.DataFrame({
                'prescription_id': ['uuid3'],
    ...
    def test_create_manifest(self, exporter, temp_output_dir):
    ...
    def test_manifest_with_no_exports(self, exporter, temp_output_dir):
    ...
    def test_utf8_encoding(self, exporter, temp_output_dir):
    ...
    def test_csv_format_compliance(self, exporter, temp_output_dir):
    ...
    def test_multiple_exports_same_exporter(self, exporter, temp_output_dir):
